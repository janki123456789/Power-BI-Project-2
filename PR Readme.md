...
- **[customer_dim](#customer_dim)** – Customer information table
- **[date_dim](#date_dim)** – Calendar and date reference table
- **[product_dim](#product_dim)** – Product-related attributes
- **[region_dim](#region_dim)** – Region, market, and geography data
- **[sales_fact](#sales_fact)** – Primary sales transaction table
- **[returns_fact](#returns_fact)** – Returned items and return analytics
